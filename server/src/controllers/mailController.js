...
const handleAdoptionRequest = async (req, res) => {
    try {
        if (await mailValidator.handleAdoptionRequestValidator(req, res)) return
...
const getMails = async (req, res) => {
    try {
        if (await mailValidator.getMailsValidator(req, res)) return
...
const deleteMail = async (req, res) => {
    ...
    try {
        if (await mailValidator.deleteMailValidator(req, res)) {
