...
router.get('/user', authMiddleware.authenticateToken, userController.getOneUser)
router.put('/user', authMiddleware.authenticateToken, upload.single('file'), userController.editUser)
router.put('/user/address', authMiddleware.authenticateToken, userController.editAddressUser)
router.put('/user/username', authMiddleware.authenticateToken, userController.editUsername)
router.put('/user/password', authMiddleware.authenticateToken, userController.editPassword)
router.delete('/user', authMiddleware.authenticateToken, userController.deleteUser)
router.get('/user/cats', authMiddleware.authenticateToken, userController.getMyCats)

router.get('/cats', catController.getAllCats)
router.get('/cat/:id', catController.getOneCat)
router.post('/cat', authMiddleware.authenticateToken, upload.single('file'), catController.addCat)
router.put('/cat/:id', authMiddleware.authenticateToken, upload.single('file'), catController.editCat)
router.delete('/cat/:id', authMiddleware.authenticateToken, catController.deleteCat)
...
router.get('/adopts', authMiddleware.authenticateToken, adoptionRequestController.getAdoptionRequests)
...
router.post('/cats/:id/favorite', authMiddleware.authenticateToken, favoriteController.addCatToFavorites)
router.post('/favorites/:id', authMiddleware.authenticateToken, favoriteController.adoptFavorite)
router.delete('/favorite/:id', authMiddleware.authenticateToken, favoriteController.deleteFavorite)
